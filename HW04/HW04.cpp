    ...
    void searchRecipeByIngredient(const std::string& ingredient) const {
        ...
        for (size_t i = 0; i < recipes.size(); i++) {
            for (size_t k = 0; k < recipes[i].ingredients.size(); k++) {
                //검색한 레시피 존재
                if (ingredient == recipes[i].ingredients[k]) {
                    check = 0;
                    std::cout << "- 물약 이름: " << recipes[i].potionName << std::endl;
                    std::cout << "  > 필요 재료: ";
...
int main() {
    ...
    while (true) {
        ...
        if (choice == 1) {
            ...
            std::cout << "검색 할 레시피 이름을 입력하세요. (검색 완료 시 '종료' 입력)" << std::endl;
            std::cout << "레시피 이름: ";
            std::cin >> searchName;
            std::cout << std::endl;
            ...
            std::cout << "검색 할 레시피의 재료를 입력하세요. (검색 완료 시 '종료' 입력)" << std::endl;
            std::cout << "레시피 재료: ";
            std::cin >> searchIngredient;
            std::cout << std::endl;
